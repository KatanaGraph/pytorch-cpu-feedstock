...
PACKAGES_META = {
    "torch": PackageMeta("torch", "1.12.1", None),
    ...
    "sparse": PackageMeta("pytorch-sparse", "0.6.15", "https://github.com/rusty1s/pytorch_sparse.git"),
    "spline": PackageMeta("pytorch-spline-conv", "*", "https://github.com/rusty1s/pytorch_spline_conv.git"),
    "pyg": PackageMeta("pyg", "2.1.0", "https://github.com/pyg-team/pytorch_geometric.git"),
}
